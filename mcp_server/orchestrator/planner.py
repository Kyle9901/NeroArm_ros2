...
SKILL_SCHEMA = {
    "go_home": {
        "description": "将机械臂移动到 home 位置，确保相机有清晰视野。任何任务的第一步。",
        "args": {},
        "returns": "ok",
    },
    "locate_object": {
    ...
    "nod": {
        "description": "机械臂点头动作。在 home 位置通过 joint7 上下摆动实现。",
